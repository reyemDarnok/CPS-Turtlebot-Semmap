...
{
  new (message_memory) semmap_interfaces::msg::Object(_init);
}

void Object_fini_function(void * message_memory)
{
  auto typed_message = static_cast<semmap_interfaces::msg::Object *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Object_message_member_array[4] = {
  {
    ...
    offsetof(semmap_interfaces::msg::Object, distance),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(semmap_interfaces::msg::Object, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(semmap_interfaces::msg::Object, elevation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(semmap_interfaces::msg::Object, tag),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Object_message_members = {
  ...
  "Object",  // message name
  4,  // number of fields
  sizeof(semmap_interfaces::msg::Object),
...
get_message_type_support_handle<semmap_interfaces::msg::Object>()
{
  return &::semmap_interfaces::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, semmap_interfaces, msg, Object)() {
  return &::semmap_interfaces::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
