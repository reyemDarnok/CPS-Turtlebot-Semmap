...
#include "semmap_interfaces/msg/detail/emergency_stop__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const semmap_interfaces::msg::EmergencyStop & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  semmap_interfaces::msg::EmergencyStop & ros_message)
{
  // Member: cause
  cdr >> ros_message.cause;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = semmap_interfaces::msg::EmergencyStop;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const semmap_interfaces::msg::EmergencyStop *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<semmap_interfaces::msg::EmergencyStop *>(
    untyped_ros_message);
...
{
  return &semmap_interfaces::msg::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, semmap_interfaces, msg, EmergencyStop)() {
  return &semmap_interfaces::msg::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}
