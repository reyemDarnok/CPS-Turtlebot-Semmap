...
#include "semmap_interfaces/msg/detail/location__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const semmap_interfaces::msg::Location & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  semmap_interfaces::msg::Location & ros_message)
{
  // Member: orientation
  cdr >> ros_message.orientation;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = semmap_interfaces::msg::Location;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const semmap_interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<semmap_interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  return &semmap_interfaces::msg::typesupport_fastrtps_cpp::_Location__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, semmap_interfaces, msg, Location)() {
  return &semmap_interfaces::msg::typesupport_fastrtps_cpp::_Location__handle;
}
