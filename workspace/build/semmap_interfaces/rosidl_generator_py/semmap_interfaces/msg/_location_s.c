...
bool semmap_interfaces__msg__location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("semmap_interfaces.msg._location.Location", full_classname_dest, 40) == 0);
  }
  semmap_interfaces__msg__Location * ros_message = _ros_message;
  {  // orientation
...
PyObject * semmap_interfaces__msg__location__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("semmap_interfaces.msg._location");
