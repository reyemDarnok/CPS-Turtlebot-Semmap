...
#include "semmap_interfaces/msg/detail/position_history__rosidl_typesupport_fastrtps_c.h"
...
using _PositionHistory__ros_msg_type = semmap_interfaces__msg__PositionHistory;

static bool _PositionHistory__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PositionHistory__ros_msg_type * ros_message = static_cast<const _PositionHistory__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
...
static bool _PositionHistory__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _PositionHistory__ros_msg_type * ros_message = static_cast<_PositionHistory__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_semmap_interfaces__msg__PositionHistory(
  const void * untyped_ros_message,
...
static uint32_t _PositionHistory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_semmap_interfaces__msg__PositionHistory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_semmap_interfaces
size_t max_serialized_size_semmap_interfaces__msg__PositionHistory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = semmap_interfaces__msg__PositionHistory;
    is_plain =
      (
...
static size_t _PositionHistory__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_semmap_interfaces__msg__PositionHistory(
...
static message_type_support_callbacks_t __callbacks_PositionHistory = {
  "semmap_interfaces::msg",
  "PositionHistory",
  _PositionHistory__cdr_serialize,
  _PositionHistory__cdr_deserialize,
  _PositionHistory__get_serialized_size,
  _PositionHistory__max_serialized_size
};

static rosidl_message_type_support_t _PositionHistory__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PositionHistory,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, semmap_interfaces, msg, PositionHistory)() {
  return &_PositionHistory__type_support;
}
